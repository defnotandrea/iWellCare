...
@section('page-subtitle', 'View your appointment information')
@section('content')
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center gap-4 pb-4 border-b border-gray-200">
                ...
                <div>
                    ...
                    <p class="text-gray-600">{{ \Carbon\Carbon::parse($appointment->appointment_date)->format('l, M d, Y') }} at {{ \Carbon\Carbon::parse($appointment->appointment_time)->format('g:i A') }}</p>
                </div>
            </div>
            ...
            <div class="bg-gray-50 rounded-lg p-4">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="font-medium text-gray-800">Dr. {{ $appointment->doctor && $appointment->doctor->user ? $appointment->doctor->user->first_name . ' ' . $appointment->doctor->user->last_name : 'Unknown Doctor' }}</div>
                        <div class="text-sm text-gray-600">{{ $appointment->doctor ? $appointment->doctor->specialization : '' }}</div>
                        <div class="text-sm text-gray-600">{{ $appointment->doctor ? $appointment->doctor->email : '' }}</div>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div class="font-medium text-gray-800">{{ \Carbon\Carbon::parse($appointment->appointment_date)->format('l, M d, Y') }}</div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div class="font-medium text-gray-800">{{ \Carbon\Carbon::parse($appointment->appointment_time)->format('g:i A') }}</div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div class="font-medium text-gray-800">{{ ucfirst($appointment->type) }}</div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div class="font-medium text-gray-800">{{ ucfirst($appointment->priority) }}</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                ...
                <p class="text-yellow-700">{{ $appointment->notes }}</p>
            </div>
            @endif
            ...
            <div class="flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-200">
                ...
                <a href="{{ route('patient.appointments.index') }}" class="flex-1 inline-flex items-center justify-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">
    ...
    <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 transform transition-all">
        <div class="px-8 py-8">
                    ...
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-red-700">
                                <strong>Date:</strong> {{ \Carbon\Carbon::parse($appointment->appointment_date)->format('l, M d, Y') }}<br>
                                <strong>Time:</strong> {{ \Carbon\Carbon::parse($appointment->appointment_time)->format('g:i A') }}<br>
                                <strong>Doctor:</strong> Dr. {{ $appointment->doctor && $appointment->doctor->user ? $appointment->doctor->user->first_name . ' ' . $appointment->doctor->user->last_name : 'Unknown Doctor' }}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex flex-col sm:flex-row gap-3">
                <form action="{{ route('patient.appointments.cancel', $appointment) }}" method="POST" class="flex-1">
                    @csrf
