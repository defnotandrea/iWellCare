    ...
    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 p-4 lg:p-8 text-white shadow-2xl">
        ...
        <div class="relative z-10">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div class="flex-1">
                    <h1 class="text-2xl lg:text-3xl font-bold mb-2">Welcome back, {{ auth()->user()->first_name ?? 'Patient' }}! 👋</h1>
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-white text-2xl lg:text-3xl font-bold">{{ $totalAppointments }}</p>
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-white text-2xl lg:text-3xl font-bold">{{ $pendingAppointments }}</p>
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-white text-2xl lg:text-3xl font-bold">{{ $completedConsultations }}</p>
        ...
        <div class="relative z-10">
            <div class="flex items-center justify-between">
                <div class="flex-1">
                    ...
                    <p class="text-white text-2xl lg:text-3xl font-bold">{{ $unpaidInvoices }}</p>
...
<div class="mb-6 lg:mb-8">
    <div class="card p-4 lg:p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">
            <a href="{{ route('patient.appointments.create') }}" class="group flex items-center p-3 lg:p-4 bg-gradient-to-r from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg">
            ...
            <a href="{{ route('patient.appointments.index') }}" class="group flex items-center p-3 lg:p-4 bg-gradient-to-r from-green-50 to-green-100 hover:from-green-100 hover:to-green-200 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg">
            ...
            <a href="{{ route('patient.medical-records.index') }}" class="group flex items-center p-3 lg:p-4 bg-gradient-to-r from-purple-50 to-purple-100 hover:from-purple-100 hover:to-purple-200 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg">
            ...
            <a href="{{ route('patient.profile.edit') }}" class="group flex items-center p-3 lg:p-4 bg-gradient-to-r from-orange-50 to-orange-100 hover:from-orange-100 hover:to-orange-200 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg">
                ...
                <div class="flex items-center p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="font-medium text-gray-800 text-sm lg:text-base truncate">
                            Appointment with Dr. {{ $appointment->doctor ? $appointment->doctor->first_name . ' ' . $appointment->doctor->last_name : 'Unknown Doctor' }}
                        </p>
