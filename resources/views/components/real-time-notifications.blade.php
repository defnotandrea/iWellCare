    ...
    <div class="space-y-3" id="notifications-container">
        @if($notifications->count() > 0)
            @foreach($notifications as $notification)
                ...
                <div class="notification-item bg-white rounded-lg shadow-sm border-l-4 {{ $colorClass }} p-3 hover:shadow-md transition-all duration-200 transform hover:scale-[1.02]"
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="flex items-center space-x-4 mt-2 text-xs text-gray-500">
                                    @if(isset($data['doctor_name']))
                                        <span><i class="fas fa-user-md mr-1"></i>{{ $data['doctor_name'] }}</span>
                                    @endif
                                    @if(isset($data['appointment_date']))
                                        <span><i class="fas fa-calendar mr-1"></i>{{ $data['appointment_date'] }}</span>
                                    @endif
                                    @if(isset($data['appointment_time']))
                                        <span><i class="fas fa-clock mr-1"></i>{{ $data['appointment_time'] }}</span>
                                    @endif
                                </div>
                            </div>
                        </div>
