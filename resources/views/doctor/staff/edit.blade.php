...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow-md">
        <div class="p-6">
            <form method="POST" action="{{ route('doctor.staff.update', $staff) }}" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="username" value="{{ $staff->username }}" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="street_address" name="street_address" 
                                   value="{{ old('street_address', $staff->street_address) }}" 
                                   class="form-input w-full @error('street_address') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="text" id="state_province" name="state_province" 
                                   value="{{ old('state_province', $staff->state_province) }}" 
                                   class="form-input w-full @error('state_province') border-red-500 @enderror">
