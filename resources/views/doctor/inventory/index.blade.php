...
@section('page-subtitle', 'Manage your clinic inventory and supplies')
    ...
    <div class="card p-6" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white;">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-white text-3xl font-bold">{{ $inventory->total() }}</p>
            </div>
    ...
    <div class="card p-6" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); color: white;">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-white text-3xl font-bold">{{ $inventory->where('quantity', '<=', 'reorder_level')->count() }}</p>
            </div>
            <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
    ...
    <div class="card p-6" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); color: white;">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-white text-3xl font-bold">{{ $inventory->where('quantity', '<=', 0)->count() }}</p>
            </div>
            <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
    ...
    <div class="card p-6" style="background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); color: white;">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-white text-3xl font-bold">{{ $inventory->pluck('category')->unique()->count() }}</p>
            </div>
            <div class="w-12 h-12 bg-white/20 rounded-xl flex items-center justify-center">
...
<div class="card mb-6">
    <div class="p-6">
        <form method="GET" action="{{ route('doctor.inventory.index') }}" class="space-y-4">
...
<div class="card">
    <div class="px-6 py-4 border-b border-gray-100">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('doctor.inventory.create') }}" class="btn-primary">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($inventory as $item)
                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-900">{{ $item->formatted_unit_price }}</td>
                        <td class="px-6 py-4 text-sm text-gray-900">{{ $item->formatted_total_value }}</td>
                        <td class="px-6 py-4">
                            <div class="flex flex-col space-y-1">
                                ...
                                @endif
                                @if($item->isExpiredOrExpiringSoon())
                        ...
                        <td class="px-6 py-4">
                            <div class="flex space-x-2">
                                <a href="{{ route('doctor.inventory.show', $item) }}" 
                                   class="text-blue-600 hover:text-blue-900 transition-colors duration-200"
                                   title="View Details">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('doctor.inventory.edit', $item) }}"
