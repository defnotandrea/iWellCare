...
@section('page-subtitle', 'View complete medical history for ' . $patient->full_name)
        ...
        <div class="p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="text-right">
                    <a href="{{ route('doctor.patients.edit', $patient) }}" class="btn-secondary">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="font-medium">{{ $patient->user->phone ?? 'Not provided' }}</p>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 p-4 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="font-medium">{{ Str::limit($patient->address ?? 'Not provided', 30) }}</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Doctor: {{ $appointment->doctor->full_name ?? 'Unknown' }}</p>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Doctor: {{ $consultation->doctor->full_name ?? 'Unknown' }}</p>
                                </div>
                            </div>
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Doctor: {{ $prescription->doctor->full_name ?? 'Unknown' }}</p>
                                </div>
                            </div>
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Doctor: {{ $record->doctor->full_name ?? 'Unknown' }}</p>
                                </div>
                            </div>
                            <div class="text-right">
