...
<div class="inventory-content">
    <!-- Back Button -->
    <div class="mb-6">
        <a href="{{ route('admin.inventory.index') }}" class="inline-flex items-center gap-2 text-gray-600 hover:text-gray-800 transition-colors">
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <form action="{{ route('admin.inventory.store') }}" method="POST" class="space-y-8">
            @csrf
