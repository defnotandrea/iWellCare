...
<head>
    ...
    <title>{{ config('app.name', 'iWellCare') }}@hasSection('title') - @yield('title')@endif</title>
        ...
        <nav class="navbar navbar-expand-lg fixed-top">
            <div class="container">
                <a class="navbar-brand" href="{{ route('home') }}">
                    <img src="{{ asset('assets/img/iWellCare-logo.png') }}" alt="iWellCare" height="40" class="me-2">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    @if(Auth::user()->role === 'doctor')
                                        ...
                                        <li><a class="dropdown-item" href="{{ route('doctor.profile.index') }}">Profile</a></li>
                                    ...
                                    @elseif(Auth::user()->role === 'patient')
                                        ...
                                        <li><a class="dropdown-item" href="{{ route('patient.profile.index') }}">Profile</a></li>
                                    @endif
