...
<body>
    ...
    <div class="customer-section page-break">
        ...
        <div class="field-row">
            ...
            <div class="field-value"><?php echo e($invoice->patient->first_name); ?> <?php echo e($invoice->patient->last_name); ?></div>
        </div>
        <div class="customer-title">ADDRESS:</div>
        <div class="field-row">
            <div class="field-label"></div>
            <div class="field-value"><?php echo e($invoice->patient->address ?? 'N/A'); ?></div>
        </div>
    ...
    <div class="footer-section page-break">
        <div class="payment-methods">
            ...
            <div class="checkbox-item">
                <input type="checkbox" <?php echo e($invoice->status === 'paid' ? 'checked' : ''); ?>> Cash
            </div>
            <div class="checkbox-item">
...
</html><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views\admin\invoice\invoice-pdf.blade.php ENDPATH**/ ?>