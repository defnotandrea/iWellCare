...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow-md">
        <div class="p-6">
            <form method="POST" action="<?php echo e(route('doctor.staff.update', $staff)); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="username" value="<?php echo e($staff->username); ?>" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="street_address" name="street_address" 
                                   value="<?php echo e(old('street_address', $staff->street_address)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="city" name="city" 
                                   value="<?php echo e(old('city', $staff->city)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="state_province" name="state_province" 
                                   value="<?php echo e(old('state_province', $staff->state_province)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="postal_code" name="postal_code" 
                                   value="<?php echo e(old('postal_code', $staff->postal_code)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" id="country" name="country" 
                                   value="<?php echo e(old('country', $staff->country)); ?>" 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views\doctor\staff\edit.blade.php ENDPATH**/ ?>