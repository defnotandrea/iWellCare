...
<div class="patients-content">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex gap-3">
            <a href="<?php echo e(route('admin.patients.edit', $patient)); ?>" class="btn btn-secondary">
                <i class="fas fa-edit mr-2"></i>Edit Patient
            </a>
            <a href="<?php echo e(route('admin.consultations.create', ['patient_id' => $patient->id])); ?>" class="btn btn-primary">
            ...
            <div class="card p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
                        ...
                        <span class="text-gray-800"><?php echo e($patient->date_of_birth ? \Carbon\Carbon::parse($patient->date_of_birth)->format('M d, Y') : 'N/A'); ?></span>
                    </div>
                    <div class="flex justify-between items-center py-2 border-b border-gray-100">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="card p-6">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <a href="<?php echo e(route('admin.appointments.create', ['patient_id' => $patient->id])); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                        Schedule New
                    </a>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views\admin\patients\show.blade.php ENDPATH**/ ?>