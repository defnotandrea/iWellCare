...
<?php $__env->startSection('title', 'My Profile - iWellCare'); ?>
<?php $__env->startSection('page-title', 'My Profile'); ?>
<?php $__env->startSection('page-subtitle', 'Manage your personal information and account settings'); ?>
    ...
    <div class="card">
        <div class="p-6">
            <div class="flex items-center gap-6">
                ...
                <div class="flex-1">
                    <h2 class="text-2xl font-bold text-gray-900"><?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?></h2>
                    <p class="text-gray-600"><?php echo e(auth()->user()->email); ?></p>
                    <p class="text-sm text-gray-500">Patient • Member since <?php echo e(\Carbon\Carbon::parse(auth()->user()->created_at)->format('M Y')); ?></p>
                </div>
                <div class="flex items-center gap-2">
                    <a href="<?php echo e(route('patient.profile.edit')); ?>" class="btn-primary">
            ...
            <div class="p-6 space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-gray-900 font-medium"><?php echo e(auth()->user()->first_name); ?></p>
                    </div>
                    <div>
                        <label class="text-sm font-medium text-gray-600">Last Name</label>
                        <p class="text-gray-900 font-medium"><?php echo e(auth()->user()->last_name); ?></p>
                    </div>
                </div>
                
                <div>
                    <label class="text-sm font-medium text-gray-600">Username</label>
                    <p class="text-gray-900 font-medium"><?php echo e(auth()->user()->username); ?></p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-900 font-medium"><?php echo e(auth()->user()->phone_number); ?></p>
                </div>
                
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="text-sm font-medium text-gray-600">Date of Birth</label>
                        <p class="text-gray-900 font-medium"><?php echo e(auth()->user()->date_of_birth ? \Carbon\Carbon::parse(auth()->user()->date_of_birth)->format('M d, Y') : 'Not provided'); ?></p>
                    </div>
                    <div>
                        <label class="text-sm font-medium text-gray-600">Gender</label>
                        <p class="text-gray-900 font-medium capitalize"><?php echo e(auth()->user()->gender ?? 'Not specified'); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="p-6 space-y-4">
                <div>
                    ...
                    <p class="text-gray-900 font-medium"><?php echo e(auth()->user()->street_address); ?></p>
                </div>
                
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="text-sm font-medium text-gray-600">City</label>
                        <p class="text-gray-900 font-medium"><?php echo e(auth()->user()->city); ?></p>
                    </div>
                    <div>
                        <label class="text-sm font-medium text-gray-600">State/Province</label>
                        <p class="text-gray-900 font-medium"><?php echo e(auth()->user()->state_province); ?></p>
                    </div>
                </div>
                
                <div>
                    <label class="text-sm font-medium text-gray-600">Postal Code</label>
                    <p class="text-gray-900 font-medium"><?php echo e(auth()->user()->postal_code ?? 'Not provided'); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <a href="<?php echo e(route('patient.profile.edit')); ?>" class="group p-4 border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-all duration-200">
                ...
                <a href="<?php echo e(route('patient.profile.edit')); ?>" class="group p-4 border border-gray-200 rounded-lg hover:border-yellow-300 hover:bg-yellow-50 transition-all duration-200">
                    <div class="flex items-center gap-3">
...
unset($__errorArgs, $__bag); ?>
             ...
             <div class="flex flex-col sm:flex-row gap-3">
                 <form action="<?php echo e(route('patient.profile.destroy')); ?>" method="POST" class="flex-1">
                     <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.patient', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views\patient\profile\index.blade.php ENDPATH**/ ?>