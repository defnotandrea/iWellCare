...
<?php $__env->startSection('title', 'Medical Record Details - iWellCare'); ?>
<?php $__env->startSection('page-title', 'Medical Record Details'); ?>
<?php $__env->startSection('page-subtitle', 'View detailed medical record information'); ?>

<?php $__env->startSection('content'); ?>
<div class="space-y-6">
    <!-- Back Button -->
    <div class="mb-6">
        <a href="<?php echo e(route('patient.medical-records.index')); ?>" class="btn-secondary">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h4 class="text-lg font-semibold text-gray-900"><?php echo e($record->title); ?></h4>
                            <p class="text-gray-600"><?php echo e(ucfirst($record->type)); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="bg-green-50 rounded-lg p-4">
                        ...
                        <div class="space-y-2 text-sm">
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium"><?php echo e(ucfirst($record->type)); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Recorded Date:</span>
                                <span class="font-medium"><?php echo e(\Carbon\Carbon::parse($record->created_at)->format('M d, Y')); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Recorded By:</span>
                                <span class="font-medium">Dr. <?php echo e($record->doctor->first_name); ?> <?php echo e($record->doctor->last_name); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="card">
        ...
        <div class="p-6">
            <div class="bg-blue-50 rounded-lg p-4">
                <p class="text-gray-700"><?php echo e($record->description); ?></p>
            </div>
        </div>
    </div>
    <?php endif; ?>
    ...
    <?php if($record->type === 'lab_result' && $record->lab_results): ?>
    <div class="card">
        <div class="px-6 py-4 border-b border-gray-100">
        ...
        <div class="p-6">
            <div class="bg-yellow-50 rounded-lg p-4">
                <pre class="text-gray-700 whitespace-pre-wrap"><?php echo e($record->lab_results); ?></pre>
            </div>
        </div>
    </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.patient', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views\patient\medical-records\show.blade.php ENDPATH**/ ?>