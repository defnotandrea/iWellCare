...
<?php $__env->startSection('title', 'Doctor Availability Management - iWellCare'); ?>
<?php $__env->startSection('page-title', 'Doctor Availability Management'); ?>
<?php $__env->startSection('page-subtitle', 'Manage doctor availability status'); ?>
...
<div class="doctor-availability-content">
    ...
    <div class="flex justify-between items-center">
        ...
        <a href="<?php echo e(route('staff.doctor-availability.create')); ?>" class="btn btn-primary">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="card p-6">
            <div class="flex items-center justify-between mb-4">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500"><?php echo e($doctor->specialization); ?></p>
                    </div>
                </div>
                <?php
                ...
                ?>
                <span class="px-3 py-1 rounded-full text-sm font-medium <?php echo e($status['is_available'] ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
            ...
            <div class="space-y-3">
                ...
                <?php if($latestSetting && !$status['is_available']): ?>
                    ...
                    <div class="text-sm">
                        ...
                        <span class="ml-2 text-gray-600"><?php echo e($latestSetting->notes); ?></span>
                    </div>
                    <?php endif; ?>
                <?php endif; ?>
                ...
                <div class="text-xs text-gray-500">
                    <span class="font-medium">Set by:</span> <?php echo e($latestSetting->setBy->first_name ?? ''); ?> <?php echo e($latestSetting->setBy->last_name ?? 'System'); ?><br>
                    <span class="font-medium">Updated:</span> <?php echo e($latestSetting->updated_at->format('M d, Y H:i')); ?>
            ...
            <div class="mt-6 flex space-x-2">
                <button onclick="setAvailable(<?php echo e($doctor->id); ?>)" class="flex-1 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
                    <i class="fas fa-check mr-1"></i>Available
                </button>
                <button onclick="setUnavailable(<?php echo e($doctor->id); ?>)" class="flex-1 bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
    ...
    <div class="card p-6">
        ...
        <div class="space-y-4">
            <?php $__currentLoopData = $availabilitySettings->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                ...
                <div class="text-right">
                    <p class="text-sm text-gray-500"><?php echo e($setting->created_at->format('M d, Y H:i')); ?></p>
                    <?php if($setting->status !== 'available'): ?>
                    <p class="text-xs text-gray-400"><?php echo e(ucfirst($setting->status)); ?></p>
                    <?php endif; ?>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
