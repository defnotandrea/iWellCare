                ...
                <div class="table-responsive">
                    <table class="table iwc-table align-middle mb-0">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $prescriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prescription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($prescription->patient->user->first_name); ?> <?php echo e($prescription->patient->user->last_name); ?></td>
                                ...
                                <td>
                                    <?php $__currentLoopData = $prescription->medications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $med): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div><?php echo e($med->name); ?></div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </td>
                                <td>
                                    <?php $__currentLoopData = $prescription->medications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $med): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div><?php echo e($med->dosage); ?></div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </td>
                                <td><?php echo e($prescription->instructions); ?></td>
                                <td><?php echo e($prescription->prescription_date->format('Y-m-d')); ?></td>
                                <td>
                                    <span class="badge bg-<?php echo e($prescription->status == 'active' ? 'primary' : ($prescription->status == 'completed' ? 'success' : 'secondary')); ?>">
                                        <?php echo e(ucfirst($prescription->status)); ?>

                                    </span>
                                </td>
                                <td class="text-center">
                                    <a href="<?php echo e(route('doctor.prescriptions.show', $prescription)); ?>" class="btn btn-sm btn-outline-info rounded-pill me-1">View</a>
                                    <a href="<?php echo e(route('doctor.prescriptions.edit', $prescription)); ?>" class="btn btn-sm btn-outline-warning rounded-pill me-1">Edit</a>
                                    <form action="<?php echo e(route('doctor.prescriptions.destroy', $prescription)); ?>" method="POST" style="display:inline-block;">
                                        <?php echo csrf_field(); ?>
        ...
        <div class="p-6">
            ...
            <form action="<?php echo e(route('doctor.prescriptions.store')); ?>" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <select name="patient_id" id="modal_patient_id" class="form-control rounded" required>
                        ...
                        <?php $__currentLoopData = $patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($patient->id); ?>"><?php echo e($patient->user->first_name); ?> <?php echo e($patient->user->last_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="prescription_date" id="modal_prescription_date" class="form-control rounded" value="<?php echo e(date('Y-m-d')); ?>" required>
                </div>
                <div class="mb-4">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views\doctor\prescriptions\index.blade.php ENDPATH**/ ?>