        ...
        <div class="p-6">
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900"><?php echo e($patient->first_name ?? 'N/A'); ?> <?php echo e($patient->last_name ?? ''); ?></h2>
                ...
                <div class="text-right">
                    <a href="<?php echo e(route('staff.patients.edit', $patient)); ?>" class="btn-secondary">
                ...
                <div class="bg-gray-50 p-4 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="font-medium"><?php echo e($patient->user->phone_number ?? 'Not provided'); ?></p>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 p-4 rounded-lg">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="font-medium"><?php echo e(Str::limit($patient->user->street_address ?? 'Not provided', 30)); ?></p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Doctor: <?php echo e($appointment->doctor->first_name ?? 'Unknown'); ?> <?php echo e($appointment->doctor->last_name ?? ''); ?></p>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Doctor: <?php echo e($consultation->doctor->first_name ?? 'Unknown'); ?> <?php echo e($consultation->doctor->last_name ?? ''); ?></p>
                                </div>
                            </div>
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Doctor: <?php echo e($prescription->doctor->first_name ?? 'Unknown'); ?> <?php echo e($prescription->doctor->last_name ?? ''); ?></p>
                                </div>
                            </div>
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Doctor: <?php echo e($record->doctor->first_name ?? 'Unknown'); ?> <?php echo e($record->doctor->last_name ?? ''); ?></p>
                                </div>
                            </div>
                            <div class="text-right">
...
<?php echo $__env->make('layouts.staff', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views\staff\patients\history.blade.php ENDPATH**/ ?>