...
<?php $__env->startSection('page-subtitle', 'Manage patient records and information'); ?>
...
<div class="space-y-8">
    ...
    <div class="card p-6">
        ...
        <form method="GET" action="<?php echo e(route('admin.patients.index')); ?>" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 items-end">
            <div>
            ...
            <div class="flex gap-2">
                ...
                <a href="<?php echo e(route('admin.patients.index')); ?>" class="btn btn-secondary flex items-center gap-2">
                    ...
                    <tr class="hover:bg-blue-50 transition-colors duration-200">
                        ...
                        <td class="py-4 px-6">
                            <div class="flex flex-wrap gap-2">
                                <a href="<?php echo e(route('admin.patients.show', $patient)); ?>"
                                ...
                                <a href="<?php echo e(route('admin.consultations.create', ['patient_id' => $patient->id])); ?>"
                                ...
                                <button type="button" class="inline-flex items-center px-3 py-1.5 text-xs font-medium rounded-md text-red-600 bg-red-100 hover:bg-red-200 transition-colors duration-200"
                                        onclick="deletePatient(<?php echo e($patient->id); ?>)">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views\admin\patients\index.blade.php ENDPATH**/ ?>