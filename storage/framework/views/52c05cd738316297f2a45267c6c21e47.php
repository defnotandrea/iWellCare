...
<div class="patients-content">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="<?php echo e(route('staff.patients.index')); ?>" class="btn btn-secondary">
    ...
    <div class="card p-6 max-w-4xl mx-auto">
        ...
        <form action="<?php echo e(route('staff.patients.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.staff', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views\staff\patients\create.blade.php ENDPATH**/ ?>