...
<?php $__env->startSection('title', 'Consultations Report'); ?>
...
<div class="container-fluid">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="<?php echo e(route('staff.reports.consultations')); ?>" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <div class="d-grid gap-2 d-md-flex">
                        ...
                        <a href="<?php echo e(route('staff.reports.consultations')); ?>" class="btn btn-outline-secondary">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($consultations->total()); ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($consultations->where('status', 'completed')->count()); ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($consultations->where('status', 'in_progress')->count()); ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($consultations->where('status', 'pending')->count()); ?></div>
                        </div>
                        <div class="col-auto">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <strong><?php echo e($consultation->patient->first_name); ?> <?php echo e($consultation->patient->last_name); ?></strong>
                                <br><small class="text-muted"><?php echo e($consultation->patient->email); ?></small>
                            </td>
                            <td>
                                <strong><?php echo e($consultation->doctor->first_name); ?> <?php echo e($consultation->doctor->last_name); ?></strong>
                                <?php if($consultation->doctor->specialization): ?>
                                    <br><small class="text-muted"><?php echo e($consultation->doctor->specialization); ?></small>
                                <?php endif; ?>
                            </td>
                            <td>
                                <strong><?php echo e($consultation->created_at->format('M d, Y')); ?></strong>
                                <br><small class="text-muted"><?php echo e($consultation->created_at->format('H:i')); ?></small>
                            </td>
                            <td>
                                <span class="badge bg-secondary"><?php echo e($consultation->consultation_type ? $consultation->consultation_type : 'General'); ?></span>
                            </td>
                            <td>
                                <?php switch($consultation->status):
                                    ...
                                    <?php case ('cancelled'): ?>
                                        ...
                                        <?php break; ?>
                                    <?php default: ?>
                                        <span class="badge bg-secondary"><?php echo e(ucfirst($consultation->status)); ?></span>
                                <?php endswitch; ?>
                            </td>
                            <td>
                                <?php if($consultation->diagnosis): ?>
                                    <small class="text-muted"><?php echo e(Str::limit($consultation->diagnosis, 50)); ?></small>
                                <?php else: ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views\staff\reports\consultations.blade.php ENDPATH**/ ?>