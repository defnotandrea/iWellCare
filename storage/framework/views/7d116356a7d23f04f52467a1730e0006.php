        ...
        <form action="<?php echo e(route('patient.appointments.store')); ?>" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div class="bg-gray-50 rounded-xl p-6">
                    ...
                    <?php if($defaultDoctor): ?>
                        <div class="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg">
                            <div class="flex items-center">
                                <i class="fas fa-star text-green-600 mr-2"></i>
                                <span class="text-green-700 text-sm font-medium">
                                    Dr. <?php echo e($defaultDoctor->user->first_name); ?> <?php echo e($defaultDoctor->user->last_name); ?> is pre-selected as your default doctor
                                </span>
                            </div>
                        </div>
                    <?php endif; ?>
                                ...
                                <div class="flex items-center justify-between p-2 rounded-lg <?php echo e($doctor->current_availability['is_available'] ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'); ?>">
                                    <div class="flex items-center">
                                        ...
                                        <span class="font-medium text-gray-900">
                                            Dr. <?php echo e($doctor->user ? $doctor->user->first_name . ' ' . $doctor->user->last_name : 'Unknown Doctor'); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                    ...
                    <a href="<?php echo e(route('patient.appointments.index')); ?>" class="btn btn-secondary flex-1 text-lg py-4 px-8 rounded-xl transition-all duration-200">
