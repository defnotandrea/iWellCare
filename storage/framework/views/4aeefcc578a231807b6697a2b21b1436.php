        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-lg">
                ...
                <div id="otp-codes-container">
                    <?php if(count($otpCodes) > 0): ?>
                        <div class="divide-y divide-gray-200">
                            <?php $__currentLoopData = $otpCodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $otp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="flex items-center space-x-4">
                                                ...
                                                <div class="flex-1 min-w-0">
                                                    <p class="text-sm font-medium text-gray-900">
                                                        <?php echo e($otp['Name'] ?? 'Unknown User'); ?>

                                                    </p>
                                                    <p class="text-sm text-gray-500">
                                                        <?php echo e($otp['Email'] ?? 'No email'); ?>

                                                    </p>
                                                    <p class="text-xs text-gray-400 mt-1">
                                                        Type: <?php echo e($otp['Type'] ?? 'Unknown'); ?> | 
                                                        Expires: <?php echo e($otp['Expires'] ?? 'Unknown'); ?>
...
<?php /**PATH C:\xampp\htdocs\iWellCare\resources\views\otp-display.blade.php ENDPATH**/ ?>