                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-bold text-gray-900">₱<?php echo e(number_format($monthlyStats['current']['revenue'], 2)); ?></span>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600">Revenue</span>
                            <span class="font-bold text-gray-900">₱<?php echo e(number_format($monthlyStats['last']['revenue'], 2)); ?></span>
                        </div>
                    </div>
                </div>
            </div>
