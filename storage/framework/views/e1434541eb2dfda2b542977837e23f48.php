...
<div class="flex justify-end mb-6">
    <a href="<?php echo e(route('admin.invoice.create')); ?>" class="btn btn-primary flex items-center gap-2">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-blue-50 transition-colors duration-200">
                        <td class="py-4 px-6">
                            <div class="font-medium text-blue-600"><?php echo e($invoice->invoice_no ?? 'INV-' . str_pad($invoice->id, 6, '0', STR_PAD_LEFT)); ?></div>
                        </td>
                        <td class="py-4 px-6">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="min-w-0 flex-1">
                                    <div class="font-medium text-gray-900"><?php echo e($invoice->patient->first_name ?? '-'); ?> <?php echo e($invoice->patient->last_name ?? ''); ?></div>
                                    <div class="text-xs text-gray-500"><?php echo e($invoice->patient->email ?? ''); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="py-4 px-6">
                            <div class="font-medium text-gray-900"><?php echo e($invoice->appointment ? $invoice->appointment->appointment_date->format('M d, Y') : '-'); ?></div>
                            <div class="text-xs text-gray-500"><?php echo e($invoice->appointment ? $invoice->appointment->appointment_time->format('h:i A') : ''); ?></div>
                        </td>
                        <td class="py-4 px-6">
                            <div class="font-bold text-lg text-gray-900">₱<?php echo e(number_format($invoice->grand_total ?? $invoice->amount, 2)); ?></div>
                        </td>
                        <td class="py-4 px-6">
                        ...
                        <td class="py-4 px-6">
                            <div class="font-medium text-gray-900"><?php echo e($invoice->payment_date ? \Carbon\Carbon::parse($invoice->payment_date)->format('M d, Y') : '-'); ?></div>
