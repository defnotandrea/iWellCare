    ...
    <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <form method="GET" action="" class="flex flex-wrap gap-3 items-end flex-1">
            <div class="min-w-0 flex-1 lg:flex-initial">
                ...
                <input type="text" name="name" class="form-input w-full" value="<?php echo e(request('name')); ?>" placeholder="Search items...">
            </div>
            <div class="min-w-0">
        ...
        <a href="<?php echo e(route('staff.inventory.create')); ?>" class="btn btn-success flex items-center gap-2 px-4 py-2 whitespace-nowrap" style="background: linear-gradient(90deg, #2563eb 0%, #1d4ed8 100%);">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $inventory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-blue-50/50 transition-colors border-b border-gray-100 last:border-b-0">
                        ...
                        <td class="py-2 px-3">
                            <a href="<?php echo e(route('staff.inventory.edit', $item->id)); ?>" class="inline-flex items-center gap-1 px-2 py-1 text-white text-xs font-medium rounded-md transition-colors" style="background: linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%);">
