...
<div class="consultations-content">
    ...
    <div class="flex justify-between items-center">
        ...
        <div class="flex gap-3">
            <a href="<?php echo e(route('admin.consultations.index')); ?>" class="btn btn-secondary flex items-center gap-2">
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <?php $__currentLoopData = $patients ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($patient && is_object($patient)): ?>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <?php $__currentLoopData = $doctors ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($doctor && is_object($doctor)): ?>
                                        <option value="<?php echo e($doctor->id); ?>" <?php echo e(old('doctor_id', $selectedDoctorId ?? '') == $doctor->id ? 'selected' : ''); ?>>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function saveDraft() {
        ...
        fetch('<?php echo e(route("admin.consultations.store")); ?>', {
            method: 'POST',
            body: formData,
            headers: {
