...
<body>
    ...
    <div class="section">
        ...
        <div class="chart-container">
            ...
            <div class="chart-bar">
                <div class="chart-bar-fill" style="height: <?php echo e($activeHeight); ?>px; background-color: #28a745;"></div>
                <div class="chart-bar-value"><?php echo e($active); ?></div>
                <div class="chart-bar-label">Active</div>
            </div>
            <div class="chart-bar">
                <div class="chart-bar-fill" style="height: <?php echo e($inactiveHeight); ?>px; background-color: #6c757d;"></div>
                <div class="chart-bar-value"><?php echo e($inactive); ?></div>
                <div class="chart-bar-label">Inactive</div>
            </div>
            <div class="chart-bar">
                <div class="chart-bar-fill" style="height: <?php echo e($newHeight); ?>px; background-color: #ffc107;"></div>
                <div class="chart-bar-value"><?php echo e($new); ?></div>
    ...
    <div class="section">
        ...
        <?php if($topPatients->count() > 0): ?>
            <table>
                ...
                <tbody>
                    <?php $__currentLoopData = $topPatients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="text-center"><?php echo e($index + 1); ?></td>
                        <td><strong><?php echo e($patient->first_name); ?> <?php echo e($patient->last_name); ?></strong></td>
...
</html> <?php /**PATH C:\xampp\htdocs\iWellCare\resources\views\doctor\reports\pdf\patient-summary.blade.php ENDPATH**/ ?>