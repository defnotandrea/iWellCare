...
<body class="bg-gray-50">
    <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="bg-white rounded-xl shadow-2xl border border-gray-200 p-8">
                <div class="text-center mb-8">
                    ...
                    <?php if($email): ?>
                        <p class="text-gray-600 text-sm">
                            ...
                            <span class="font-semibold text-gray-900"><?php echo e($email); ?></span>
                        </p>
                    <?php else: ?>
                        <p class="text-gray-600 text-sm">
                ...
                <?php if(!$email): ?>
                    <!-- Email Input Form -->
                    <form method="POST" action="<?php echo e(route('otp.send')); ?>" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        <div>
                ...
                <?php else: ?>
                    ...
                    <form method="POST" action="<?php echo e(route('otp.verify')); ?>" class="space-y-6">
                        <?php echo csrf_field(); ?>
                    ...
                    <div class="mt-6 text-center">
                        ...
                        <form method="POST" action="<?php echo e(route('otp.resend')); ?>" class="inline" id="resendForm">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="email" value="<?php echo e($email); ?>">
                            <button type="submit" 
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const otpForm = document.querySelector('form[action="<?php echo e(route("otp.verify")); ?>"]');
            if (otpForm) {
...
</html> <?php /**PATH C:\xampp\htdocs\iWellCare\resources\views\auth\verify-otp-simple.blade.php ENDPATH**/ ?>