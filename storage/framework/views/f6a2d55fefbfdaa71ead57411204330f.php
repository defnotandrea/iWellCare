...
<div class="max-w-4xl mx-auto py-8">
    ...
    <div class="bg-white rounded-xl shadow-lg p-8">
        ...
        <form action="<?php echo e(route('book.appointment.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="space-y-2">
                            <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-2 rounded-lg <?php echo e($doctor->current_availability['is_available'] ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'); ?>">
                                    <div class="flex items-center">
                                        <div class="w-3 h-3 rounded-full mr-3 <?php echo e($doctor->current_availability['is_available'] ? 'bg-green-500' : 'bg-red-500'); ?>"></div>
                                        <span class="font-medium text-gray-900">
                                            Dr. <?php echo e($doctor->user->first_name); ?> <?php echo e($doctor->user->last_name); ?>

                                        </span>
                                        <span class="text-sm text-gray-600 ml-2">(<?php echo e($doctor->specialization ?? 'General'); ?>)</span>
                                    </div>
                                    <div class="text-sm font-medium <?php echo e($doctor->current_availability['is_available'] ? 'text-green-700' : 'text-red-700'); ?>">
                                        <?php if($doctor->current_availability['is_available']): ?>
                                            <i class="fas fa-check-circle mr-1"></i>Available
                                        <?php else: ?>
                                            <i class="fas fa-times-circle mr-1"></i><?php echo e($doctor->current_availability['message']); ?>
                    ...
                    <select name="doctor_id" id="doctor_id" class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-lg transition-colors" required>
                        ...
                        <?php $__currentLoopData = $doctors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($doctor->id); ?>"
                                <?php if(!$doctor->current_availability['is_available']): ?> disabled <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="bg-gray-50 rounded-xl p-6">
                        ...
                        <select name="appointment_time" id="appointment_time" class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-lg transition-colors" required>
                            ...
                            <option value="09:00" <?php echo e(old('appointment_time') == '09:00' ? 'selected' : ''); ?>>9:00 AM</option>
                            <option value="09:30" <?php echo e(old('appointment_time') == '09:30' ? 'selected' : ''); ?>>9:30 AM</option>
                            <option value="10:00" <?php echo e(old('appointment_time') == '10:00' ? 'selected' : ''); ?>>10:00 AM</option>
                            <option value="10:30" <?php echo e(old('appointment_time') == '10:30' ? 'selected' : ''); ?>>10:30 AM</option>
                            <option value="11:00" <?php echo e(old('appointment_time') == '11:00' ? 'selected' : ''); ?>>11:00 AM</option>
                            <option value="11:30" <?php echo e(old('appointment_time') == '11:30' ? 'selected' : ''); ?>>11:30 AM</option>
                            <option value="14:00" <?php echo e(old('appointment_time') == '14:00' ? 'selected' : ''); ?>>2:00 PM</option>
                            <option value="14:30" <?php echo e(old('appointment_time') == '14:30' ? 'selected' : ''); ?>>2:30 PM</option>
                            <option value="15:00" <?php echo e(old('appointment_time') == '15:00' ? 'selected' : ''); ?>>3:00 PM</option>
                            <option value="15:30" <?php echo e(old('appointment_time') == '15:30' ? 'selected' : ''); ?>>3:30 PM</option>
                            <option value="16:00" <?php echo e(old('appointment_time') == '16:00' ? 'selected' : ''); ?>>4:00 PM</option>
                            <option value="16:30" <?php echo e(old('appointment_time') == '16:30' ? 'selected' : ''); ?>>4:30 PM</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bg-gray-50 rounded-xl p-6">
                    ...
                    <select name="appointment_type" id="appointment_type" class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-lg transition-colors" required>
                        ...
                        <option value="Regular Checkup" <?php echo e(old('appointment_type') == 'Regular Checkup' ? 'selected' : ''); ?>>Regular Checkup</option>
                        ...
                        <option value="Follow-up" <?php echo e(old('appointment_type') == 'Follow-up' ? 'selected' : ''); ?>>Follow-up</option>
                    </select>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bg-gray-50 rounded-xl p-6">
                    ...
                    <textarea name="symptoms" id="symptoms" rows="4"
                              ...
                              class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-lg resize-none transition-colors"><?php echo e(old('symptoms')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bg-gray-50 rounded-xl p-6">
                    ...
                    <textarea name="notes" id="notes" rows="3"
                              ...
                              class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-lg resize-none transition-colors"><?php echo e(old('notes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-200">
                    ...
                    <a href="<?php echo e(route('home')); ?>" class="btn btn-secondary flex-1 text-lg py-4 px-8 rounded-xl transition-all duration-200">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\iWellCare\resources\views\appointments\booking.blade.php ENDPATH**/ ?>